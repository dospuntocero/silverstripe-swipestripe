  ...
  function onBeforeDelete() {
    ...
    if ($member->inGroup('customers')) {
      ...
      if ($orders && $orders->exists()) {
        throw new Exception(_t('Customer.CANTDELETECUSTOMER',"Can't not delete this customer because he have orders on the system."));
      }
    }
	}
  ...
  public function canDelete($member = null) {
	...
	public function getCMSFields() {
	  ...
	  $fields = parent::getCMSFields();
		...
		$fields->addFieldToTab('Root.Address', new TextField('PostalCode',_t('Customer.POSTALCODE',"Postal Code")));
